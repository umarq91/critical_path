...
function DialogHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("flex shrink-0 flex-col gap-1.5 p-5 pr-11 pb-4", className)}
      {...props}
    />
  )
}
...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "flex shrink-0 flex-col-reverse gap-2 border-t bg-muted/50 p-5 sm:flex-row sm:justify-end",
        className
      )}
      {...props}
    >
