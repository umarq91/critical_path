...
function SelectValue({ className, ...props }: SelectPrimitive.Value.Props) {
  return (
    <SelectPrimitive.Value
      ...
      className={cn(
        "flex min-w-0 flex-1 items-center gap-1.5 overflow-hidden text-left text-ellipsis whitespace-nowrap",
        className
      )}
      {...props}
    />
